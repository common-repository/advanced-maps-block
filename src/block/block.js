	...
	edit: class extends Component {
		...
		handleCreateGoogleMap() {
			...
			const markers = this.state.locations,
				center = this.state.mapCenter.lat ? this.state.mapCenter : {
		...
		render() {
			...
			const map = this.props.attributes.apiKey ? <div className="advanced-maps-block" style={ { height: this.props.attributes.mapHeight + 'px' } } /> : <div className="empty-api">
				<div className="advanced-maps-block__overlay">
					<h3>Advanced Maps Block</h3>
					<p>Please add your <a href="https://developers.google.com/maps/documentation/javascript/get-api-key" target="_blank" rel="noopener noreferrer">Google Maps API Key</a> to use the Advanced Maps Block.</p>
					<p>This block requires Google's <a href="https://developers.google.com/maps/documentation/geocoding/overview" target="_blank" rel="noopener noreferrer">Geocoding API</a> and <a href="https://developers.google.com/maps/documentation/javascript/overview" target="_blank" rel="noopener noreferrer">Maps JavaScript API</a> be enabled.</p>
					<TextControl
						label={ __( 'API Key' ) }
			...
			return [
				<InspectorControls key="1">
					...
					>
						...
						{ this.props.attributes.apiKey ? <p>If the API key is valid but the map is still not showing, make sure that the <a href="https://developers.google.com/maps/documentation/geocoding/overview" target="_blank" rel="noopener noreferrer">Geocoding API</a> and <a href="https://developers.google.com/maps/documentation/javascript/overview" target="_blank" rel="noopener noreferrer">Maps JavaScript API</a> are enabled.</p> : null }
					</PanelBody>
					<PanelBody
